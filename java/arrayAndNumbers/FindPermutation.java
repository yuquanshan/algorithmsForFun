...
* the secret signature "DI" can be constructed by array [2,1,3] or [3,1,2], but 
* won't be constructed by array [3,2,4] or [2,1,3,4], which are both illegal 
...
public class FindPermutation {
	...
	public static void main(String[] args) {
		...
		String s = "IDDD";
		System.out.println(Arrays.toString(test.findPermutation(s)));
	}
}